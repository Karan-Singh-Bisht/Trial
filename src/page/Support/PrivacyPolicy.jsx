...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-container max-w-[70vw] mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4">Privacy Policy</h1>
      <p className="text-sm text-gray-600">Last updated: April 08, 2025</p>
      ...
      <section className="my-8">
        ...
        <ul className="list-disc pl-6 my-3 space-y-2">
          ...
          <li>
            <strong>Application</strong> refers to VishVaam, the software
            program provided by the Company.
          </li>
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to HarSar Studios Pvt Ltd,
            Hyderabad, Telanagana 500080.
          </li>
          <li>
      ...
      <section className="my-8">
        ...
        <h4 className="text-md font-medium mt-3 mb-1">
      ...
      <section className="my-8">
        ...
        <p className="my-2">
          ...
          have one, and visiting the account settings section that allows you to
      ...
      <section className="my-8">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">Business Transactions</h3>
        <p>
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">Law enforcement</h3>
        <p>
      ...
      <section className="my-8">
        ...
        <p className="my-2">
          By email:{" "}
          <a
            href="mailto:harsarstudios@gmail.com"
            className="text-blue-600 hover:underline"
          >
            harsarstudios@gmail.com
          </a>
        </p>
      </section>
    </div>
